...
const localStorageExercise = "myw4072-park-list";
...
const loadJSONFromLocalStorage = () => {
  const string = localStorage.getItem(localStorageExercise);
  let json;
  try{
...
export const writeToLocalStorage = (key, value) => {
  ...
  json[key] = value;
  localStorage.setItem(localStorageExercise, JSON.stringify(json));
};

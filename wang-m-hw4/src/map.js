...
const accessToken = "pk.eyJ1IjoibXl3NDA3MiIsImEiOiJjbHVqOGM3cjEwYzRuMmtvY2N5OHZiZ3Y0In0.sHNanMSM6mlAArkOINa4KQ";
let map;
...
const addMarkersToMap = (json, clickHandler) => {
	geojson = json;//replace hard-coded json data

	//loop through array and add marker

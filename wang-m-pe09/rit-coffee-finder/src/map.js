...
function addMarkersToMap(coordinates, title, description, className = 'marker'){
    // add markers to map
...
export {initMap,loadMarkers,addMarkersToMap, flyTo, setZoomLevel, setPitchAndBearing, geojson};